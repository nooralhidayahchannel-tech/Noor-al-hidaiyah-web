...
const cards = [
  ...
  },
  {
    icon: "🙏",
    title: "الأدعية",
    text: "أدعية مأثورة لكل موقف من مواقف يومك.",
    href: "/duas",
  },
  {
    icon: "💰",
    title: "حساب الزكاة",
    text: "احسب زكاة مالك بسهولة ودقة.",
    href: "/zakat",
  },
  {
    icon: "📅",
    title: "خطة ختم القرآن",
    text: "خطة يومية تساعدك تختم القرآن بالمدة اللي تحددها.",
    href: "/khatma",
  },
  {
    icon: "📍",
    title: "المساجد القريبة",
    text: "أقرب المساجد لموقعك على الخريطة.",
    href: "/mosques",
  },
  {
    icon: "📿",
    title: "التسبيح",
    text: "عدّاد تسبيح رقمي بسيط وسلس.",
    href: "/tasbih",
  },
  {
    icon: "🤚",
    title: "المكروهات",
    text: "أمور يُستحب تجنّبها اقتداءً بالسنة.",
    href: "/makrooh",
  },
  {
    icon: "⛔",
    title: "المحرّمات",
    text: "أمور نهى عنها الشرع، ينبغي اجتنابها.",
    href: "/haram",
  },
];
